...
currentYearSpan.textContent = new Date().getFullYear(2025);
...
const skillInfo = {
    "STRATEGIZING": "STRATEGIZING is the ability to create a plan in order to carry it out",
    "PATIENCE": "PATIENCE is the capacity to accept or tolerate delay",
    "LEADERSHIP": "LEADERSHIP is the ability to direct a group of people in order to achieve an particular goal ."
};
